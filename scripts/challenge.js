...
problem_set.grab_the_red_queen.answer = $(".glyphicon-queen.red");

problem_set.grab_the_square_the_red_queen_is_in.answer = $(".square.endangered");

problem_set.remove_the_endangered_class_from_the_red_queens_square; // MODIFY THE DOM DIRECTLY!
$(".square.endangered").removeClass("endangered");
